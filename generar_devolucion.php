  ...
  <table border="0" cellpadding="0" cellspacing="0" width="776">
    <tbody>
      ...
      <tr>
        ...
        <td  class="tituloDOSE_2"><span class="negrita">&nbsp;&nbsp;SUB TOTAL: </span><?php echo $row_factura['sub_total']; ?></td>
      ...
      <tr>
        <td class="tituloDOSE_2" ><span class="negrita">&nbsp;&nbsp;IVA: </span><?php echo $row_factura['iva']; ?></td>
      </tr>
      <tr>
        <td class="tituloDOSE_2" ><span class="negrita">&nbsp;&nbsp;TOTAL A PAGAR: </span><?php echo $row_factura['total']; ?></td>
      </tr>
      <tr>
...
mysql_select_db($database_conexion, $conexion);
$query_productos = "SELECT * FROM productos where id_producto='$row_venta[id_producto]'";
...
$total=$row_venta['precio'] * $row_venta['cantidad'];
		?>  
          <tr id="lista_detalles">
            ...
            <td width="86" scope="col"><?php echo $row_venta['precio'];?>
              <input type="hidden" name="precio<?=$i?>" id="precio<?=$i?>" value="<?=$row_venta['precio']?>" /></td>
            <td width="86" scope="col"><?php echo $total; ?></td>
        </tr>
          <?php 
		  $i++;
