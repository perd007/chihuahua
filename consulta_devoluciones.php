...
if($_COOKIE["val"]==true){
	if($_COOKIE["f"]!=1){
	echo "<script type=\"text/javascript\">alert ('Usted no posee permisos para Devoluciones'); location.href='fondo.php' </script>";
    exit;
	}
}
else{
...
if ($fBuscar != "") { 
	$filtro.=" and id_cliente LIKE '%".utf8_decode($fBuscar)."%' OR
...
mysql_select_db($database_conexion, $conexion);
$query_pedidos = "SELECT * FROM facturas where transaccion='DEVOLUCION' $filtro";
...
if($totalRows_pedidos==0){
  echo "<script type=\"text/javascript\">alert ('No existen Devoluciones Registradas');  location.href='fondo.php' </script>";
  exit;
  }
?>
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="743" >
    <tbody>
      <tr>
        ...
        <td colspan="4" align="center" valign="center" background="imagenes/v_back_sup.jpg" class="tituloDOSE_3"><span class="negrita">Devoluciones Realizadas</span></td>
      ...
      <tr align="center" class="centrar">
        ...
        <td width="315"  valign="baseline" bgcolor="#437bc6"class="negrita">Cliente</td>
        <td width="119"  valign="baseline" bgcolor="#437bc6"class="negrita">Cedula</td>
        <td width="176" valign="baseline" bgcolor="#437bc6" class="negrita">Fecha y Hora</td>
        <td width="106" valign="baseline" bgcolor="#437bc6" class="negrita">Ver</td>
      ...
      <tr class="trListaBody" style=" font-size: 14px;">
        ...
        <td align="center"><a href="ver_devolucion.php?id=<?php echo $row_pedidos['id_facturas']; ?>">
      ...
      <tr>
        ...
        <td background="imagenes/v_back_der.gif" width="14"><img src="imagenes/cargar_productos.php" alt="1" height="2" width="13" /></td>
      </tr>
      <tr>
