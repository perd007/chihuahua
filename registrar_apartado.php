...
/////////////////////////////////////////////////////////////////////
  ...
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());
	...
	$insert_pedido= sprintf("INSERT INTO apartados (fecha, id_cliente, correlativo, total, iva, subtotal) VALUES (NOW(), %s,%s, %s, %s, %s)",
  ...
  echo "<script type=\"text/javascript\">alert ('APARTADO');  location.href='' </script>";
  }else{
...
<input type="hidden" name="sel_detalles" id="sel_detalles" />
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="775">
    ...
    <tr>
      ...
      <td align="center" valign="top"><input type="submit" name="addAll2" id="addAll2" value="PROCESAR" onClick="return validarEnviar()"/></td>
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="776">
    <tbody>
      ...
      <tr>
        ...
        <td colspan="2" valign="top" class="tituloDOSE_2"> Cedula o Rif:
...
<input type="hidden" name="TipoClasificacion" id="FlagCompras" value="C" /></td>
      ...
      <tr>
        <td class="tituloDOSE_2" valign="top" width="375"><table border="0" cellpadding="0" cellspacing="0" width="594">
          <tbody>
            <tr>
              <td width="13" align="left"  ></td>
              <td  height="1" class="tituloDOSE_2"><table border="0" cellpadding="0" cellspacing="0">
                <tbody>
                  <tr>
                    <td align="right"></td>
                  </tr>
                    ...
                    <td align="center" width="140"><table cellpadding="3" cellspacing="0" width="566">
                      <tbody>
                        <tr>
                          ...
                          <td width="214" valign="baseline"><input name="nombres" type="text" id="nombres" value="<?php echo $row_clientes['nombres']; ?>"  size="32" maxlength="20" <?=$disable?>/></td>
                          <td width="109" align="right" valign="baseline" nowrap="nowrap">Cedula o Rif:</td>
                          <td width="155" valign="baseline"><input name="cedula" type="text" id="cedula" value="<?php echo $row_clientes['cedula']; ?>" size="32" maxlength="8" <?=$disable?>/></td>
                        </tr>
                        <tr>
        ...
        <td class="tituloDOSE_2" valign="top" width="375"><p id="para1"  class="negrita"/>&nbsp;</p>
          <p id="para2" class="negrita"/>&nbsp;</p>
          <p id="para3" class="negrita"/>&nbsp;</p></td>
      </tr>
      <tr>
        <td align="left" height="12" width="13"><img src="imagenes/v_esq_izq_inf.gif" alt="5" height="12" width="13" /></td>
