...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
 ...
 while($_POST["nrodetalle"]>=$i){ 
			...
			if($_POST['precio'.$i]=="" or $_POST['precio'.$i]<=0){
				 echo "<script type=\"text/javascript\">alert ('El Precio debe ser mayor a Cero');  location.href='' </script>"; exit;
...
<input type="hidden" name="sel_detalles" id="sel_detalles" />
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="775">
    ...
    <tr>
      ...
      <td align="center" valign="top"><input type="submit" name="addAll2" id="addAll2" value="PROCESAR PEDIDO" onClick="return validarEnviar()"/></td>
                      ...
                      <td align="center" width="140"><table cellpadding="3" cellspacing="0" width="566">
                        <tbody>
                          <tr>
                            ...
                            <td width="112" align="right" valign="baseline" nowrap="nowrap">Cedula o Rif:</td>
                            <td width="152" valign="baseline"><input name="cedula" type="text" id="cedula" value="<?php echo $row_clientes['cedula']; ?>" size="32" maxlength="8" <?=$disable?>/></td>
                          </tr>
                          <tr>
