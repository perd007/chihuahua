...
<table border="0" cellpadding="0" cellspacing="0" width="776">
  <tbody>
    ...
    <tr>
      ...
      <td  class="tituloDOSE_2"><span class="negrita">&nbsp;&nbsp;SUB TOTAL: </span><?php echo $row_pedido['sub_total']; ?></td>
    ...
    <tr>
      <td class="tituloDOSE_2" ><span class="negrita">&nbsp;&nbsp;TOTAL PAGADO: </span><?php echo $row_pedido['total']; ?></td>
    </tr>
    <tr>
