...
<table border="0" cellpadding="0" cellspacing="0" width="760" >
  <tbody>
    ...
    <tr align="center" class="centrar">
      ...
      <td width="248"  valign="baseline" bgcolor="#437bc6"class="negrita">Fecha y Hora de Apertura</td>
      <td width="246" valign="baseline" bgcolor="#437bc6" class="negrita">
        <label for="tipo2">Fecha y Hora de Cierra</label></td>
      <td width="159" valign="baseline" bgcolor="#437bc6" class="negrita">Estado</td>
      <td width="80" valign="baseline" bgcolor="#437bc6" class="negrita">Opciones</td>
