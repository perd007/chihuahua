...
<table border="0" cellpadding="0" cellspacing="0" width="760" >
  <tbody>
    <tr>
      ...
      <td colspan="5" align="center" valign="center" background="imagenes/v_back_sup.jpg" class="tituloDOSE_3"><span class="negrita">Visualizar Productos
      </span></td>
    ...
    <tr align="center" class="letras">
      ...
      <td width="193"  valign="baseline" bgcolor="#6da6e2"class="negrita">Nombre</td>
      <td width="162" valign="baseline" bgcolor="#6da6e2" class="negrita">
        <label for="tipo2">Marca</label>
      </td>
      <td width="151" valign="baseline" bgcolor="#6da6e2" class="negrita">Codigo</td>
      <td width="114" valign="baseline" bgcolor="#6da6e2" class="negrita">Opciones</td>
      <td width="114" valign="baseline" bgcolor="#6da6e2" class="negrita">Opciones</td>
    ...
    <?php do { ?>
      <tr class="trListaBody" onclick="mClk(this, 'registro');" id="<?php echo $row_prod['id_productos']; ?>">
        ...
        <td align="center"><a href="modificar_producto.php?id=<?php echo $row_prod['id_producto']; ?>"><input type="button"  value="Modificar" /></a></td>
        <td align="center"><a  onclick='return validar()' href="eliminar_productos.php?id=<?php echo $row_prod['id_producto']; ?>"><input type="button"  value="Eliminar" /></a></td>
        <td background="imagenes/v_back_der.gif">&nbsp;</td>
      </tr>
