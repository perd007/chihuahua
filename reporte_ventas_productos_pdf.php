...
//Funcion para el Encabezado
	...
	$this->Ln(20);
	$this->Row(array('REPORTE DE VENTAS DE PRODUCTOS'));
	$this->Ln(10);
...
//agregamos encabezados de productos
	...
	$pdf->SetWidths(array(80,70));
	$pdf->SetAligns(array('L', 'C'));
	$pdf->Row(array('Producto','Cantidad Vendida'));
	$pdf->Ln(2);
...
for ($j=0; $j<$numfilas; $j++)   {
	...
	if($validador[$j]==1){
		$pdf->Row(array($producto_nombre[$j],  $producto_cantidad[$j] ));
	} 
}
