...
<table border="0" cellpadding="0" cellspacing="0" width="755" >
  <tbody>
    ...
    <tr align="center" class="centrar">
      <td background="imagenes/v_back_izq.gif" height="1">&nbsp;</td>
      <td width="141"  valign="baseline" bgcolor="#437bc6"class="negrita">Apetura</td>
      <td width="147"  valign="baseline" bgcolor="#437bc6"class="negrita">Cierre</td>
      <td width="87" valign="baseline" bgcolor="#437bc6" class="negrita">Efectivo </td>
      <td width="87" valign="baseline" bgcolor="#437bc6" class="negrita">Debito</td>
      <td width="87" valign="baseline" bgcolor="#437bc6" class="negrita">Cheque</td>
      <td width="87" valign="baseline" bgcolor="#437bc6" class="negrita">Deposito</td>
      <td width="93" valign="baseline" bgcolor="#437bc6" class="negrita">Total </td>
      <td background="imagenes/v_back_der.gif">&nbsp;</td>
    </tr>
    <tr class="trListaBody">
      ...
      <td align="center"><?php echo $debito; ?></td>
