...
mysql_select_db($database_conexion, $conexion);
$query_pedidos = "SELECT * FROM apartados $filtro";
...
if($totalRows_pedidos==0){
  echo "<script type=\"text/javascript\">alert ('No existen Apartados Cargados');  location.href='fondo.php' </script>";
  exit;
  }
...
<table border="0" cellpadding="0" cellspacing="0" width="743" >
  <tbody>
    <tr>
      ...
      <td colspan="5" align="center" valign="center" background="imagenes/v_back_sup.jpg" class="tituloDOSE_3"><span class="negrita">Lista de Apartados</span></td>
      <td align="right" height="1" width="17"><img src="imagenes/vc_esq_der_sup.gif" alt="6" height="32" width="13" /></td>
    </tr>
    <tr align="center" class="centrar">
      <td background="imagenes/v_back_izq.gif" height="1">&nbsp;</td>
      <td width="235"  valign="baseline" bgcolor="#437bc6"class="negrita">Cliente</td>
      <td width="119"  valign="baseline" bgcolor="#437bc6"class="negrita">Cedula</td>
      <td width="197" valign="baseline" bgcolor="#437bc6" class="negrita">Fecha y Hora</td>
      <td width="81" valign="baseline" bgcolor="#437bc6" class="negrita">Facturar</td>
      <td width="81" valign="baseline" bgcolor="#437bc6" class="negrita">Eliminar</td>
	  ...
	  ?>
        <tr class="trListaBody" style=" font-size: 14px;">
          ...
          <td align="center"><a href="facturar_apartados.php?apartado=<?php echo $row_pedidos['id_apartado']; ?>"><img src="imagenes/botonFacturar.png" width="81" height="26" />
          </a></td>
          <td align="center"><a href="eliminar_pedidos.php?apartado=<?php echo $row_pedidos['id_apartado']; ?>"><img src="imagenes/botonEliminar.png" width="81" height="26" /></a></td>
          <td background="imagenes/v_back_der.gif">&nbsp;</td>
        </tr>
    ...
    <tr>
      ...
      <td background="imagenes/v_back_der.gif" width="17"><img src="imagenes/cargar_productos.php" alt="1" height="2" width="13" /></td>
  </tr>
    <tr>
      ...
      <td align="right" height="1" width="17"><img src="imagenes/v_esq_der_inf.gif" alt="4" height="12" width="13" /></td>
    </tr>
  </tbody>
</table>
<p>&nbsp;</p>
