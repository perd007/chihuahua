...
<table border="0" cellpadding="0" cellspacing="0" width="639">
  <tbody>
    <tr>
      ...
      <td class="tituloDOSE_3" align="center" background="imagenes/v_back_sup.jpg" valign="center"><span class="negrita">Visualizar Precios Registrados de Productos</span></td>
    ...
    <tr>
      ...
      <input type="text" name="codigo" id="codigo" readonly="readonly" class="dato"  style="text-align:center; font-weight:bold;" value="<?=$_POST["codigo"]?>" size="20"  /><input type="text" name="nombre" id="nombre" readonly="readonly" class="dato" value="<?=$_POST["nombre"]?>" style="text-align:center; font-weight:bold;" size="32" />
      <a  href="listado_productos_ajuste.php?iframe=true&amp;width=950&amp;height=525" target="_blank" rel="prettyPhoto[iframe1]" >
  
        <img src="imagenes/f_boton.png" alt="" width="20" style="cursor:pointer;" title="Seleccionar" align="absbottom" />
      </a></td>
      <td width="13" rowspan="3" background="imagenes/v_back_der.gif"><img src="imagenes/cargar_productos.php" alt="1" height="2" width="13" /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td valign="top"><table width="645" align="center" class="tblLista">
        <thead>
          <tr>
            <th width="210">Fecha</th>
            <th  width="123">Tipo Aumento</th>
            <th  width="124">Monto Aumento</th>
            <th  width="168">Precio</th>
          </tr>
          <?php do { ?>
            <tr>
              <td align="center" class="Letras"><?php echo $row_precios['fecha']; ?></td>
              <td align="center" class="Letras"><?php echo $row_precios['tipoAumento']; ?></td>
              <td align="center" class="Letras"><?php echo $row_precios['montoAumento']; ?></td>
