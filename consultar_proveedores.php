...
<table width="788" border="0" align="left" cellpadding="0" cellspacing="0" >
  <tbody>
    ...
    <tr align="center" class="centrar">
      ...
      <td width="373"  valign="baseline" bgcolor="#0033FF"class="negrita">Nombre</td>
      <td width="116" valign="baseline" bgcolor="#0033FF" class="negrita"><label for="tipo2">Rif</label></td>
      <td width="129" valign="baseline" bgcolor="#0033FF" class="negrita">Telefono</td>
      ...
      <td width="11" background="imagenes/v_back_der.gif">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td background="imagenes/v_back_izq.gif" height="1" width="16"><img src="imagenes/v_back_izq.gif" alt="3" height="2" width="13" /></td>
    ...
    <tr>
      <td align="left" height="1" width="16"><img src="imagenes/v_esq_izq_inf.gif" alt="5" height="12" width="13" /></td>
