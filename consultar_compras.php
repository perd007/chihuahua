...
<table border="0" cellpadding="0" cellspacing="0" width="760" >
  <tbody>
    ...
    <tr align="center" class="centrar">
      ...
      <td width="103"  valign="baseline" bgcolor="#437bc6"class="negrita">Fecha</td>
      <td width="122" valign="baseline" bgcolor="#437bc6" class="negrita"><label for="tipo2">N° Factura</label></td>
      <td width="375" valign="baseline" bgcolor="#437bc6" class="negrita">Proveedor</td>
      <td width="68" valign="baseline" bgcolor="#437bc6" class="negrita">Opciones</td>
      <td width="66" valign="baseline" bgcolor="#437bc6" class="negrita">Opciones</td>
