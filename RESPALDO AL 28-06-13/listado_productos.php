...
<table width="100%" class="tblLista">
	<thead>
	<tr>
		<th width="106" scope="col">ID</th>
		<th width="492" scope="col">Tipo</th>
		<th width="286" scope="col">Marca</th>
        <th width="286" scope="col">Modelo</th>
        <th width="286" scope="col">Nombre</th>
        <th width="286" scope="col">Descripcion</th>
	...
	$rows_lista = mysql_num_rows($query);
		...
		if ($ventana == "requerimiento_detalles_insertar") {
			?><tr class="trListaBody" onclick="requerimiento_detalles_insertar('<?=$field["id_productos"]?>', 'item');" id="<?=$field['id_productos']?>"><?
		}
		?>
		<td align="center"><?=$field['id_productos']?></td>
