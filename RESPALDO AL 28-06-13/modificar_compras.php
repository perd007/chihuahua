...
//actualizamos datos basicos
  ...
  $updateSQL = sprintf("UPDATE compras SET fecha=%s, num_fac=%s, proveedor=%s WHERE id_compras=%s",
                ...
                <tbody>
                  ...
                  <tr>
                    <td align="center" width="140"><table cellpadding="3" cellspacing="0" width="689">
                      <tbody>
                        <tr>
                          <td width="120" align="right" valign="baseline" nowrap="nowrap">Fecha de Compras:</td>
                          <td width="199" valign="baseline"><input name="fecha" type="text" id="fecha" value="<?php echo $row_compras['fecha']; ?>" size="20" maxlength="10" readonly="readonly" />
                          ...
                          <td width="58" align="right" valign="baseline" nowrap="nowrap">Factura:</td>
                          <td width="286" valign="baseline"><input type="text" name="num_fac" id="num_fac" value="<?php echo $row_compras['num_fac']; ?>" size="32" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td colspan="3" valign="baseline" class="gallery clearfix"><input name="rif" type="text" id="rif" value="<?php echo $row_compras['proveedor']; ?>" size="20" maxlength="12" readonly="readonly" />
                            <input name="proveedor" id="proveedor" value="<?php echo $row_proveedor['nombre']; ?>" readonly="readonly" type="text" size="80" maxlength="46" />
			...
			$nrodetalles++;
				...
				?>
                 <tr  class="trListaBody" onclick="mClk(this, 'sel_detalles');" id="detalles_<?=$nrodetalles?>" >
                                ...
                                <td width="79" align="center"><?=$field["producto"]?><input type="hidden" name="id<?=$nrodetalles?>" class="cell2" style="text-align:center;" value="<?=$field["producto"]?>"/> </td>
                                ...
                                <td  width="131"><input type="text" name="Cantidad<?=$nrodetalles?>" class="cell" style="text-align:right; font-weight:bold;" value="<?=$field["cantidad"]?>" /></td>
                                <td  width="131"><input type="text" name="costo<?=$nrodetalles?>" class="cell" style="text-align:right; font-weight:bold;" value="<?=$field["precio"]?>" onBlur="numeroBlur(this);" onFocus="numeroFocus(this);" /></td>
                             </tr>
