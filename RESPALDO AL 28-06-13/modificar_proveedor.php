...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE proveedor SET rif=%s, nombre=%s, telefono=%s, direccion=%s, descripcion=%s WHERE id_proveedor=%s",
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td colspan="3" valign="baseline"><label for="direccion"></label>
                      <textarea name="direccion" onkeydown="if(this.value.length &gt;= 500){ alert('Has superado el tamaño máximo permitido de este campo'); return false; }" id="direccion" cols="75" rows="6"><?php echo $row_proveedor['direccion']; ?></textarea></td>
                  </tr>
                  <tr>
                    <td class="tituloDOSE_2" align="left">Descripcion</td>
                    <td colspan="3" valign="baseline"><label for="descrpcion"></label>
                      <textarea name="descrpcion" onkeydown="if(this.value.length &gt;= 300){ alert('Has superado el tamaño máximo permitido de este campo'); return false; }" id="descrpcion" cols="75" rows="4"></textarea></td>
                  </tr>
                  <tr>
