...
//insertamos los datos de la compra
  $insertSQL = sprintf("INSERT INTO compras ( fecha, num_fac, proveedor) VALUES ( %s, %s, %s)",
  ...
  <tbody>
    <tr>
                  ...
                  <td align="center" width="140"><table cellpadding="3" cellspacing="0" width="689">
                    <tbody>
                      <tr>
                        ...
                        <td width="199" valign="baseline"><input name="fecha" type="text" id="fecha" value="<?=date("Y/m/d");?>" size="20" maxlength="10" readonly="readonly" />
      ...
      <script type="text/javascript">
                        ...
                        <td width="286" valign="baseline"><input type="text" name="num_fac" id="num_fac" value="" size="32" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td colspan="3" valign="baseline" class="gallery clearfix">
                          <input name="rif" id="rif" readonly="readonly" type="text" size="20" maxlength="12" />
                          <input name="proveedor" id="proveedor" readonly="readonly" type="text" size="80" maxlength="46" />
                          
                          <a  href="listaproveedores.php?iframe=true&amp;width=950&amp;height=525" target="_blank" rel="prettyPhoto[iframe1]" ><img src="imagenes/f_boton.png" alt="" width="20" style="cursor:pointer;" title="Seleccionar" align="absbottom" /></a>                          <input type="hidden" name="TipoClasificacion" id="FlagCompras" value="C" /></td>
                      </tr>
                      <tr>
    			...
    			<tbody id="lista_detalles">
                      ...
                      <tr>
                        <td colspan="4" align="center"><input type="submit" value="CARGAR COMPRAS" /></td>
                      </tr>
                    </tbody>
                  </table></td>
                </tr>
