...
<table width="788" border="0" align="left" cellpadding="0" cellspacing="0" >
  <tbody>
    <tr>
      ...
      <td colspan="7" align="center" valign="center" background="imagenes/v_back_sup.jpg" class="tituloDOSE_3"><span class="negrita">Consulta de Proveedores</span></td>
    ...
    <tr align="center" class="centrar">
      ...
      <td width="175"  valign="baseline" bgcolor="#0033FF"class="negrita">Nombre</td>
      <td width="94" valign="baseline" bgcolor="#0033FF" class="negrita"><label for="tipo2">Rif</label></td>
      <td width="102" valign="baseline" bgcolor="#0033FF" class="negrita">Telefono</td>
      <td width="139" valign="baseline" bgcolor="#0033FF" class="negrita">Direccion</td>
      <td width="123" valign="baseline" bgcolor="#0033FF" class="negrita">Descripcion</td>
      <td width="68" valign="baseline" bgcolor="#0033FF" class="negrita">Opciones</td>
      <td width="62" valign="baseline" bgcolor="#0033FF" class="negrita">Opciones</td>
    ...
    <?php do { ?>
      <tr class="trListaBody" onclick="mClk(this, 'registro');" id="<?php echo $row_prod['id_productos']; ?>">
        ...
        <td align="center"><?php echo $row_prove['direccion']; ?></td>
        <td align="center"><?php echo $row_prove['descrpcion']; ?></td>
        <td align="center"><a href="modificar_proveedor.php?id=<?php echo $row_prove['id_proveedor']; ?>&rif=<?php echo $row_prove['rif']; ?>">
          <input type="button"  value="Modificar" />
        </a></td>
        <td align="center"><a onclick='return validar()' href="eliminar_proveedor.php?id=<?php echo $row_prove['id_proveedor']; ?>">
    ...
    <tr>
      ...
      <td colspan="7" class="tituloDOSE_2"><table border="0" align="center">
        <tr>
