...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO proveedor (rif, nombre, direccion,telefono) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['rif'], "int"),
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td colspan="3" valign="baseline"><label for="direccion"></label>
                      <textarea name="direccion" onkeydown="if(this.value.length &gt;= 500){ alert('Has superado el tamaño máximo permitido de este campo'); return false; }" id="direccion" cols="75" rows="6"></textarea></td>
                  </tr>
                  <tr>
