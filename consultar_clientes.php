...
<table border="0" cellpadding="0" cellspacing="0" width="769" >
  <tbody>
    ...
    <tr align="center" class="centrar">
      ...
      <td width="97" valign="baseline" bgcolor="#437bc6" class="negrita">Cedula o Rif</td>
      <td width="64" valign="baseline" bgcolor="#437bc6" class="negrita">Tipo</td>
      <td width="87" valign="baseline" bgcolor="#437bc6" class="negrita">Telefono</td>
      <td width="183" valign="baseline" bgcolor="#437bc6" class="negrita">Direccion</td>
