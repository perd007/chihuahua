...
<table border="0" cellpadding="0" cellspacing="0" width="722">
  <tbody>
    <tr>
      ...
      <td width="694" align="center" valign="center" background="imagenes/v_back_sup.jpg" class="tituloDOSE_3"><span class="negrita">Datos  del Clientes</span></td>
      <td align="right" height="1" width="15"><img src="imagenes/vc_esq_der_sup.gif" alt="6" height="32" width="13" /></td>
    </tr>
    <tr>
      ...
      <td width="15" rowspan="2" background="imagenes/v_back_der.gif"><img src="imagenes/cargar_productos.php" alt="1" height="2" width="13" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="right" height="12" width="15"><img src="imagenes/v_esq_der_inf.gif" alt="4" height="12" width="13" /></td>
    </tr>
  </tbody>
</table>
<table border="0" cellpadding="0" cellspacing="0" width="719">
  <tbody>
    ...
    <tr>
      ...
      <td width="223" align="center" valign="top" class="tituloDOSE_2"> <div id="para1"  class="negrita">&nbsp;&nbsp;SUB TOTAL: <?php echo $row_pedido['sub_total']; ?></div></td>
      <td width="176" align="center" valign="top" class="tituloDOSE_2"> <div id="para2"  class="negrita">&nbsp;&nbsp;IVA: <?php echo $row_pedido['iva']; ?></div></td>
      <td width="295" align="center" valign="top" class="tituloDOSE_2"> <div id="para3"  class="negrita">&nbsp;&nbsp;TOTAL A PAGAR: <?php echo $row_pedido['total']; ?></div></td>
    ...
    <tr>
      ...
      <td colspan="3" valign="top" class="tituloDOSE_2">Tipo de Pago:
        ...
        <label for="radio5">Efectivo
          <input name="efectivo" type="text" id="efectivo" size="11" value="<?php if($row_pedido['efectivo']<0)echo $row_pedido['total']; else echo $row_pedido['efectivo'] ?>"   disabled="disabled" maxlength="11" />
        </label>
        Debito
        <input name="debito" type="text" value="<?php if($row_pedido['debito']<0)echo $row_pedido['total']; else echo $row_pedido['debito'] ?>"  disabled="disabled" id="debito" size="11" maxlength="11" /> 
        Cheque
        <input name="cheque" value="<?php if($row_pedido['cheque']<0)echo $row_pedido['total']; else echo $row_pedido['cheque'] ?>" type="text"  disabled="disabled" id="cheque" size="11" maxlength="11" /></td>
      <td width="12" background="imagenes/v_back_der.gif"><img src="imagenes/cargar_productos.php" alt="1" height="2" width="13" /></td>
    </tr>
    <tr>
      <td height="26" background="imagenes/v_back_izq.gif">&nbsp;</td>
      <td colspan="3" valign="top" class="tituloDOSE_2">&nbsp;</td>
      <td background="imagenes/v_back_der.gif">&nbsp;</td>
    </tr>
    <tr>
      <td height="26" background="imagenes/v_back_izq.gif">&nbsp;</td>
    ...
    <tr >
      ...
      <table width="700" align="center" class="tblLista">
       ...
       <th width="80" scope="col">Codigo</th>
		...
		mysql_select_db($database_conexion, $conexion);
		$query_productos = "SELECT * FROM productos where id_producto='$row_productos_pedidos[id_producto]'";
