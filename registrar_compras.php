...
//insertamos los datos de la compra
  ...
  $insertSQL = sprintf("INSERT INTO compras ( fecha, num_fac, proveedor,  subtotal, iva, total) VALUES (%s, %s, %s, %s, %s, %s)",
 ...
 //insertamos los productos
  if($Result1){
	...
	//cargamos el almacen
	$insertSQL3 = sprintf("INSERT INTO almacen (id_producto, factura_compra, cantidad, transaccion) VALUES (%s, %s, %s, %s)",
