...
if ($fBuscar != "") { 
	$filtro.=" where id_cliente LIKE '%".utf8_decode($fBuscar)."%' OR
					serie LIKE '%".utf8_decode($fBuscar)."%' OR
					numero LIKE '%".utf8_decode($fBuscar)."%' OR
...
$query_pedidos = "SELECT * FROM facturas $filtro";
...
if($totalRows_pedidos==0){
  echo "<script type=\"text/javascript\">alert ('No existen Facturas Registradas');  location.href='fondo.php' </script>";
  exit;
  }
?>
...
<body>
<form id="form1" name="form1" method="post" action="consultar_facturas.php">

<div class="divBorder" style="width:400px;">
  <table width="400" align="center" class="tblFiltro">
    <tr b="b">
      <td height="21" align="center" class="negrita">Buscar</td>
      </tr>
    <tr b="b">
      <td height="29" align="center" class="negrita"><input type="text" name="fBuscar" id="fBuscar" value="<?=$fBuscar?>" style="width:250px;"/></td>
      </tr>
    <tr>
      <td align="center"><input type="submit" class="negrita" value="Buscar" /></td>
    </tr>
  </table>
</div>
<table border="0" cellpadding="0" cellspacing="0" width="770" >
  <tbody>
    <tr>
      ...
      <td colspan="5" align="center" valign="center" background="imagenes/v_back_sup.jpg" class="tituloDOSE_3"><span class="negrita">Consultar Facturas </span></td>
    ...
    <tr align="center" class="centrar">
      ...
      <td width="232"  valign="baseline" bgcolor="#437bc6"class="negrita">Cliente</td>
      <td width="119"  valign="baseline" bgcolor="#437bc6"class="negrita">Cedula</td>
      <td width="154" valign="baseline" bgcolor="#437bc6" class="negrita">Factura</td>
      <td width="158" valign="baseline" bgcolor="#437bc6" class="negrita">Fecha y Hora</td>
      <td width="81" valign="baseline" bgcolor="#437bc6" class="negrita">Visualizar</td>
	  ...
	  ?>
        <tr class="trListaBody" style=" font-size: 14px;">
          ...
          <td align="center"><?php echo $row_pedidos['numero']; ?></td>
          <td align="center"><?php echo $row_pedidos['fecha']; ?></td>
          <td align="center"><a href="ver_factura.php?id=<?php echo $row_pedidos['id_facturas']; ?>"><input type="button" value="VER" /></a></td>
          <td background="imagenes/v_back_der.gif">&nbsp;</td>
        </tr>
