...
<table border="0" cellpadding="0" cellspacing="0" width="769" >
  <tbody>
    <tr>
      ...
      <td colspan="7" align="center" valign="center" background="imagenes/v_back_sup.jpg" class="tituloDOSE_3"><span class="negrita">Consulta de Usuarios</span></td>
    ...
    <tr align="center" class="centrar">
      ...
      <td width="167"  valign="baseline" bgcolor="#437bc6"class="negrita">Nombre</td>
      <td width="97" valign="baseline" bgcolor="#437bc6" class="negrita">Cedula </td>
      <td width="91" valign="baseline" bgcolor="#437bc6" class="negrita">Cargo</td>
      <td width="128" valign="baseline" bgcolor="#437bc6" class="negrita">Telefono</td>
      <td width="115" valign="baseline" bgcolor="#437bc6" class="negrita">Usuario</td>
      <td width="68" valign="baseline" bgcolor="#437bc6" class="negrita">Opciones</td>
      <td width="77" valign="baseline" bgcolor="#437bc6" class="negrita">Opciones</td>
