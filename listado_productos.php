...
<table width="100%" class="tblLista">
	<thead>
	<tr>
		<th width="102" scope="col">Codigo</th>
		<th width="230" scope="col">Nombre</th>
		<th width="120" scope="col">Marca</th>
	...
	$rows_lista = mysql_num_rows($query);
		...
		if ($ventana == "requerimiento_detalles_insertar") {
			?><tr class="trListaBody" onclick="requerimiento_detalles_insertar('<?=$field["id_producto"]?>', 'item');" id="<?=$field['id_producto']?>"><?
		}
		?>
