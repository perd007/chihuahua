...
if($_COOKIE["val"]==true){
	if($_COOKIE["f"]!=1){
	echo "<script type=\"text/javascript\">alert ('Usted no posee permisos para realizar Devoluciones'); location.href='fondo.php' </script>";
    exit;
	}
}
else{
...
<body>
<form id="form1" name="form1" method="post" onsubmit="return validar()" action="generar_devolucion.php">
