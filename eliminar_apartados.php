...
if($verificar){
	echo"<script type=\"text/javascript\">alert ('Apartado Eliminado'); location.href='lista_apartados.php' </script>";
}
else{
	echo"<script type=\"text/javascript\">alert ('Error'); location.href='lista_apartados.php' </script>";
...
<table border="0" cellpadding="0" cellspacing="0" width="775">
  <tbody>
    <tr>
      <td align="left" height="1"><img src="imagenes/vc_esq_izq_sup.gif" alt="7" height="32" width="13" /></td>
      <td class="tituloDOSE_3" align="center" background="imagenes/v_back_sup.jpg" valign="center"><span class="negrita">Apartado a Cancelar</span></td>
    ...
    <tr>
      ...
      <td align="center" valign="top"><input type="submit" name="button2" id="button2" value="ELIMINARAPARTADO" /></td>
